              ...
              <div
                ...
                <div className="flex h-11 w-full cursor-pointer select-none flex-row justify-between  py-2.5 pl-3 pr-2 text-white">
                  ...
                  <svg
                    ...
                    <path
                      fill="#D0D0D0"
                      d="M17 9.17a1 1 0 00-1.41 0L12 12.71 8.46 9.17a1 1 0 00-1.41 0 1 1 0 000 1.42l4.24 4.24a1 1 0 001.42 0L17 10.59a1 1 0 000-1.42z"></path>
                  </svg>
                </div>
              </div>
              {isDropDownOpen && (
                  ...
                  <div className="flex h-11 w-full cursor-pointer select-none hover:bg-tercery flex-row justify-between bg-secondary py-2.5 pl-3 pr-2 text-white ">
                    <div className="flex flex-row items-center w-full ">
                      <a href={user?.githuburl} target="_blank" rel="noopener">
                        <span className="text-green-500 leading-6">view profile</span>
                      </a>
                    </div>
                  </div>
